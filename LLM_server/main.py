...
client = Groq(api_key="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")
...
async def get_response(query: Query):
    try:
        ...
        messages.append({
        "role": "user",
        "content": "I will provide simple answers based on the query if it matches the available data. If no matching data is found, I will respond with 'I am sorry.' " + queryFinal
        })
